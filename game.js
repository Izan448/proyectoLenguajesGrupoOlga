...
const TEAMS = [
  ...
  { name: 'Suïssa',        abbr: 'SUI', flag: '🇨🇭', color: '#D52B1E', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Dinamarca',     abbr: 'DEN', flag: '🇩🇰', color: '#C60C30', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Sèrbia',        abbr: 'SRB', flag: '🇷🇸', color: '#C6363C', accent: '#0C4076', textColor: '#FFFFFF' },
  { name: 'Polònia',       abbr: 'POL', flag: '🇵🇱', color: '#DC143C', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Gal·les',       abbr: 'WAL', flag: '🏴󠁧󠁢󠁷󠁬󠁳󠁿', color: '#D30731', accent: '#00AB39', textColor: '#FFFFFF' },
  { name: 'Camerun',       abbr: 'CMR', flag: '🇨🇲', color: '#007A5E', accent: '#CE1126', textColor: '#FCD116' },
  { name: 'Canadà',        abbr: 'CAN', flag: '🇨🇦', color: '#FF0000', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Corea Sud',     abbr: 'KOR', flag: '🇰🇷', color: '#CD2E3A', accent: '#0047A0', textColor: '#FFFFFF' },
  { name: 'Austràlia',     abbr: 'AUS', flag: '🇦🇺', color: '#FFCD00', accent: '#008751', textColor: '#008751' },
  { name: 'Iran',          abbr: 'IRN', flag: '🇮🇷', color: '#239F40', accent: '#DA0000', textColor: '#FFFFFF' },
  { name: 'Aràbia S.',     abbr: 'KSA', flag: '🇸🇦', color: '#006C35', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Tunísia',       abbr: 'TUN', flag: '🇹🇳', color: '#E70013', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Costa Rica',    abbr: 'CRC', flag: '🇨🇷', color: '#CE1126', accent: '#002B7F', textColor: '#FFFFFF' },
  { name: 'Suècia',        abbr: 'SWE', flag: '🇸🇪', color: '#004B87', accent: '#FFCD00', textColor: '#FFCD00' },
  { name: 'Xile',          abbr: 'CHI', flag: '🇨🇱', color: '#D52B1E', accent: '#0039A6', textColor: '#FFFFFF' },
  { name: 'Perú',          abbr: 'PER', flag: '🇵🇪', color: '#D91023', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Nigèria',       abbr: 'NGA', flag: '🇳🇬', color: '#008751', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Algèria',       abbr: 'ALG', flag: '🇩🇿', color: '#006233', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Egipte',        abbr: 'EGY', flag: '🇪🇬', color: '#CE1126', accent: '#000000', textColor: '#FFFFFF' },
  { name: "Costa d'Iv.",   abbr: 'CIV', flag: '🇨🇮', color: '#FF8200', accent: '#009E60', textColor: '#FFFFFF' },
  { name: 'Ucraïna',       abbr: 'UKR', flag: '🇺🇦', color: '#0057B7', accent: '#FFDD00', textColor: '#FFDD00' },
  { name: 'Noruega',       abbr: 'NOR', flag: '🇳🇴', color: '#BA0C2F', accent: '#00205B', textColor: '#FFFFFF' },
  { name: 'Turquia',       abbr: 'TUR', flag: '🇹🇷', color: '#E30A17', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Grècia',        abbr: 'GRE', flag: '🇬🇷', color: '#0D5EAF', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Rep. Txeca',    abbr: 'CZE', flag: '🇨🇿', color: '#D7141A', accent: '#11457E', textColor: '#FFFFFF' },
  { name: 'Àustria',       abbr: 'AUT', flag: '🇦🇹', color: '#ED2939', accent: '#FFFFFF', textColor: '#FFFFFF' },
  { name: 'Paraguai',      abbr: 'PAR', flag: '🇵🇾', color: '#D52B1E', accent: '#0038A8', textColor: '#FFFFFF' },
  { name: 'Veneçuela',     abbr: 'VEN', flag: '🇻🇪', color: '#FCE300', accent: '#0038A8', textColor: '#0038A8' },
  { name: 'Xina',          abbr: 'CHN', flag: '🇨🇳', color: '#EE1C25', accent: '#FFFF00', textColor: '#FFFF00' },
  { name: 'Nova Zelanda',  abbr: 'NZL', flag: '🇳🇿', color: '#000000', accent: '#FFFFFF', textColor: '#FFFFFF' }
];
